  ...
  themeConfig: {
    ...
    nav: [
      { text: '主页', link: '/', icon: 'reco-home' },
      {
        ...
        icon: 'reco-message',
        items: [
          { text: 'Html', items: [{ text: 'Html', link: '/docs/Html/' }] },
          {
            text: 'Css',
            items: [
        ...
        items: [
          {
            ...
            items: [
              ...
              { text: 'nodeJs', link: '/docs/aserver/nodeJS/nodeJS' },
              { text: 'express', link: '/docs/aserver/nodeJS/express' },
              { text: 'axios', link: '/docs/aserver/axios/axios' }
            ]
          },
          {
            text: 'Vue',
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: '项目经验',
            items: [{ text: '大事件', link: '/docs/projectexperience/big-event' }],
            items: [{ text: '黑马头条', link: '/docs/projectexperience/headlines' }]
          }
        ]
      },

      {
        ...
        items: [
          {
            text: '学习资源',
            items: [{ text: '前端路线', link: '/docs/share/' }]
          },
          {
            text: '问题解决',
            items: [{ text: 'Git问题', link: '/docs/share/GitProblem/Git' }]
          }
        ]
      },
      ...
      { text: 'TimeLine', link: '/timeline/' }, //时间轴
      {
        ...
        items: [
          {
            text: 'GitHub',
            link: 'https://github.com/RedRiver-Nuo/MyHome',
            icon: 'reco-github'
          }
        ]
      }
